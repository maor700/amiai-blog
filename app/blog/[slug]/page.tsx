...
export default async function BlogArticle({
  ...
  return (
    <div className="mt-4">
      <h1>
        <span className="mt-2 block text-5xl  font-bold ">
          {title}
        </span>

      </h1>

      {/* margin of 2rem with tailwind */}
      <div className="flex justify-start items-center m-6 mx-0 p-2">
        <Image
          src={authorImage}
          width={40}
          height={40}
      ...
      <div className="flex justify-between items-center border-y text-gray-500">
        <div className="flex">
          <button className="flex items-center justify-center p-2">
            ...
            <span className="text-xs mx-1">1.5k</span>
          </button>
          <button className="flex items-center justify-center p-2">
